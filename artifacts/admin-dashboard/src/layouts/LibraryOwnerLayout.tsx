...
const NAV_ITEMS = [
  { href: "/library-owner", label: "Dashboard", icon: LayoutDashboard },
  { href: "/library-owner/seats", label: "Seats", icon: Grid3x3 },
  { href: "/library-owner/students", label: "Students", icon: Users },
  { href: "/library-owner/attendance", label: "Attendance", icon: Calendar },
  { href: "/library-owner/leaves", label: "Leaves", icon: FileCheck },
  { href: "/library-owner/shifts", label: "Shifts", icon: Clock },
];
